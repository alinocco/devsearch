...
urlpatterns = [
    ...
    path('reset/<uidb64>/<token>/',
         auth_views.PasswordResetConfirmView.as_view(template_name='users/reset.html'), name='password_reset_confirm'),
...
#       PasswordResetDoneView.as_view()         name="passsword_reset_done"
